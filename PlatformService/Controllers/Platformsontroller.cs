...
namespace PlatformService.Controllers
{
    ...
    public class Platformsontroller : ControllerBase
    {
        ...
        public Platformsontroller(IPlatformRepo repository, IMapper mapper, ICommandDataClient commandDataClient)
        {
        ...
        public async Task <ActionResult<PlatformReadDto>> CreatePlatform(PlatformCreateDto platformCreateDto)
        {
            ...
            try
            {
                await _commandDataClient.SendPlatformToCommand(platformReaDto);
            }
            catch(Exception ex)
            {
